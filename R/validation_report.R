...
#' `vivainsights::import_query()` to import your csv query files into R. This function will
#' standardize format and prepare the data as input for this report.
#'
#' For most variables, a note is returned in-line instead of an error if the variable
#' is not available.
#'
